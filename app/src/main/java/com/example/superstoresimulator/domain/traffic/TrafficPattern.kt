...
object TrafficSchedule {
    ...
    val WEEKDAY = listOf(
        ...
        TrafficPattern(6,  baseCustomerRate = 2.0f,  averageBasketSize = 3),
        TrafficPattern(7,  baseCustomerRate = 3.0f,  averageBasketSize = 3),
        // Morning build-up
        TrafficPattern(8,  baseCustomerRate = 4.0f,  averageBasketSize = 4),
        TrafficPattern(9,  baseCustomerRate = 6.0f,  averageBasketSize = 4),
        TrafficPattern(10, baseCustomerRate = 4.0f,  averageBasketSize = 3),
        // Pre-lunch
        TrafficPattern(11, baseCustomerRate = 5.0f,  averageBasketSize = 4),
        TrafficPattern(12, baseCustomerRate = 9.0f, averageBasketSize = 5), // LUNCH RUSH
        // Post-lunch
        TrafficPattern(13, baseCustomerRate = 7.0f,  averageBasketSize = 4),
        TrafficPattern(14, baseCustomerRate = 4.0f,  averageBasketSize = 3),
        TrafficPattern(15, baseCustomerRate = 4.0f,  averageBasketSize = 3),
        TrafficPattern(16, baseCustomerRate = 5.0f,  averageBasketSize = 4),
        // Evening rush
        TrafficPattern(17, baseCustomerRate = 10.0f, averageBasketSize = 6), // EVENING RUSH PEAK
        TrafficPattern(18, baseCustomerRate = 7.0f, averageBasketSize = 5),
        TrafficPattern(19, baseCustomerRate = 6.0f,  averageBasketSize = 5),
        // Winding down
        TrafficPattern(20, baseCustomerRate = 3.0f,  averageBasketSize = 4),
        TrafficPattern(21, baseCustomerRate = 1.5f,  averageBasketSize = 3),
    )
    ...
    val WEEKEND = listOf(
        ...
        TrafficPattern(10, baseCustomerRate = 10.0f, averageBasketSize = 5),
        TrafficPattern(11, baseCustomerRate = 12.0f, averageBasketSize = 6),
        TrafficPattern(12, baseCustomerRate = 15.0f, averageBasketSize = 7), // WEEKEND PEAK
        TrafficPattern(13, baseCustomerRate = 12.0f, averageBasketSize = 6),
        // Sustained afternoon — weekend shoppers linger all day
        TrafficPattern(14, baseCustomerRate = 11.0f, averageBasketSize = 6),
        TrafficPattern(15, baseCustomerRate = 10.0f, averageBasketSize = 5),
        TrafficPattern(16, baseCustomerRate = 10.0f, averageBasketSize = 5),
        // Weekend evening — still well above a weekday evening
        TrafficPattern(17, baseCustomerRate = 14.0f, averageBasketSize = 6),
        TrafficPattern(18, baseCustomerRate = 12.0f, averageBasketSize = 5),
        TrafficPattern(19, baseCustomerRate = 8.0f,  averageBasketSize = 5),
        // Winding down
